    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12"> 
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Parent Search</h5>
                    <nav class="navbar navbar-light bg-light ">
                        <div class="">
                            ...
                            <a href="{{ url('admin/parent/list/') }}" class="btn btn-primary" style="margin-left: 30px">Reset</a>
                            </form>
                        </div>
                    </nav>
                  <h5 class="card-title">Parent List (Total: {{ $getRecord->total() }})</h5>
                  <!-- Dark Table -->
                    <table class="table ">
                        <thead>
                        <tr>
